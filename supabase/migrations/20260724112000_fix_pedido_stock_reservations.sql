...
DECLARE
  ...
  v_reservado_outros_pedidos numeric(12, 3);
...
BEGIN
  ...
  INTO v_reservado_outros_pedidos
  ...
  v_disponivel_liquido := GREATEST(v_disponivel_bruto - v_reservado_outros_pedidos, 0);

  UPDATE public.almoxarifado_pedido_itens
  SET quantidade_disponivel = v_disponivel_liquido,
...
BEGIN
  ...
  FOR v_related IN
    ...
    ORDER BY p.created_at, pi.created_at
  LOOP
