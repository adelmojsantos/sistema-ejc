...
import { ChevronLeft, AlertTriangle, CheckCircle2, Users } from 'lucide-react';
      ...
      <main className="main-content container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '800px', margin: '0 auto' }}>
            ...
            {isLoadingEvents ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                {encontros.find(e => e.id === selectedEncontroId)?.ativo && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#10b981', fontWeight: 'bold', fontSize: '0.9rem', marginTop: '0.25rem' }}>
          ...
          <div className="card">
            ...
            <PessoaForm onSubmit={handleSubmit} onCancel={() => navigate(-1)} isLoading={isSaving} />
          </div>
        </div>
      </main>
          ...
          <div>
            ...
            {selectedMatch && (
              <div style={{
                padding: '1rem',
                borderRadius: '8px',
                backgroundColor: alreadyParticipant ? 'rgba(239, 68, 68, 0.1)' : 'rgba(16, 185, 129, 0.1)',
                border: `1px solid ${alreadyParticipant ? '#ef4444' : '#10b981'}`
              }}>
                {alreadyParticipant ? (
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem', color: '#065f46' }}>
